...
f <- file.path(dir_ucm_out, 'health_output_stats', 'health_london_30_zonal_stats_long_borough_2050_2050.csv'); post_fix <- 'i0_2050_2050' # 02/02/2026
f <- file.path(dir_ucm_out, 'health_output_stats', 'health_london_45_zonal_stats_long_borough_2050_2050.csv'); post_fix <- 'i0_2050_2050' # 04/15/2026
...
p <- p +
  ...
  theme(
    ...
    legend.spacing.x = unit(0.2, "cm"),  # Space between colorbars horizontally
