...
python D:/natcap/urban-cooling-health/code/health_assessment/health-modeling.py ^
    ...
    --t_scenario "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/scenario1/current_climate/intermediate/T_air_london_current_scenario_25deg_2uhi.tif" ^
    --align_to "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/current_lulc/current_climate/intermediate/T_air_london_current_scenario_20deg_2uhi.tif" ^
	...
	--baseline_deaths_cere   "G:/Shared drives/Wellcome Trust Project Data/1_preprocess/UrbanCoolingModel/OfficialWorkingInputs/health_rasters_10m_bng/f00_f99_v_mental_and_behavioural_disorders_bng10m_2021.tif" ^
