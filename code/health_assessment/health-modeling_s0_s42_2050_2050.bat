...
python D:/natcap/urban-cooling-health/code/health_assessment/health-modeling.py ^
    ...
    --t_scenario "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/scenario42/work_and_energy_runs/tcc_20prc/intermediate/T_air_london_scenario4_20prc_25.0deg_5.0uhi_45.0hum_energy_productivity.tif" ^
    ...
    --out_dir "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/health_output_s0_s42_2050_2050" ^
    --n_draws 100
