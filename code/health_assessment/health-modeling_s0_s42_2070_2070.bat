...
python D:/natcap/urban-cooling-health/code/health_assessment/health-modeling.py ^
    --t_baseline "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/scenario0/work_and_energy_runs/intermediate/T_air_london_scenario_28deg_5uhi_45hum_energy_productivity.tif" ^
    --t_scenario "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/scenario42/work_and_energy_runs/tcc_20prc/intermediate/T_air_london_scenario4_20prc_28deg_5uhi_45hum_energy_productivity.tif" ^
    --align_to   "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/scenario0/work_and_energy_runs/intermediate/T_air_london_scenario_28deg_5uhi_45hum_energy_productivity.tif" ^
    ...
    --out_dir "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/health_output_s0_s42_2070_2070" ^
    --n_draws 100
