...
C:\Users\pc\.conda\envs\geo_env\python.exe D:/natcap/urban-cooling-health/code/health_assessment/health-modeling.py ^
    ...
    --t_scenario "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/scenario520/work_and_energy_runs/intermediate/T_air_london_scenario520_25deg_5uhi_45hum_energy_productivity.tif" ^
    ...
    --out_dir "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/health_output_s0_s520_2050_2050" ^
    --n_draws 100
