...
python D:/natcap/urban-cooling-health/code/health_assessment/health-modeling.py ^
    --t_baseline "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/current_lulc/work_and_energy_runs/intermediate/T_air_london_scenario_22.0deg_2.0uhi_55.0hum_energy_productivity.tif" ^
    --t_scenario "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/scenario4/work_and_energy_runs/tcc_30prc/intermediate/T_air_london_scenario4_30prc_25.0deg_5.0uhi_45.0hum_energy_productivity.tif" ^
    --align_to   "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/current_lulc/work_and_energy_runs/intermediate/T_air_london_scenario_22.0deg_2.0uhi_55.0hum_energy_productivity.tif" ^
    ...
    --out_dir "G:/Shared drives/Wellcome Trust Project Data/2_postprocess_intermediate/UCM_official_runs/health_output_s0_s4" ^
    --n_draws 100
