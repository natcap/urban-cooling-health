...
if __name__ == '__main__':
    ...
    args['lulc_raster_path'] = os.path.join(path_prefix, '1_preprocess/UrbanCoolingModel/OfficialWorkingInputs/LULC/LCM2023_London_10m_clip2aoi_tcc24_scenario3_TreeRisk.tif')
    ...
    for c in climate:
        ...
        for temp, uhi, hum in variables:
            ...
            # Loop through current and future scenarios
                # set the suffix to have correct temp and uhi
                args['workspace_dir'] = f'{path_prefix}/2_postprocess_intermediate/UCM_official_runs/scenario3/{c}_climate'
