...
if __name__ == '__main__':
    ...
    args['lulc_raster_path'] = os.path.join(path_prefix, '1_preprocess/UrbanCoolingModel/OfficialWorkingInputs/LULC/LULC_Scenario510.tif')
    ...
    for temp, uhi, hum in variables:
        ...
        args['workspace_dir'] = os.path.join(path_prefix, '2_postprocess_intermediate/UCM_official_runs/scenario510')
        args['results_suffix'] = f'london_scenario510_{temp}deg_{uhi}uhi_{hum}hum_energy_productivity'
