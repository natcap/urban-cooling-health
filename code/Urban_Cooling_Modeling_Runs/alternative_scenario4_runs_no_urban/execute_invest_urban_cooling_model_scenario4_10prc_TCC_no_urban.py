...
if __name__ == '__main__':
    ...
    args['lulc_raster_path'] = os.path.join(path_prefix, '1_preprocess/UrbanCoolingModel/OfficialWorkingInputs/LULC/LCM2023_London_10m_clip2aoi_tcc24_scenario4_nearest_to_edge_10prc_canopy_increase.tif')
    ...
    variables = np.array([[28, 5, 45]])
    #variables = np.array([[22, 2, 55],
    #                      [22, 5, 55], [25, 2, 45], [25, 5, 45],[28, 2, 45]])
    climate = ('current')
    ...
    for c in climate:
        ...
        for temp, uhi, hum in variables:
            ...
            if sys.argv[2] == '--eap':
                ...
                args['workspace_dir'] = os.path.join(path_prefix, '2_postprocess_intermediate/UCM_official_runs/scenario4/work_and_energy_runs/tcc_10prc')
                args['results_suffix'] = f'london_scenario4_10prc_{temp}deg_{uhi}uhi_{hum}hum_energy_productivity'
