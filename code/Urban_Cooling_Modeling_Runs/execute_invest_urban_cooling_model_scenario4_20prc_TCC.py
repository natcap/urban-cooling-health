...
args = {
    ...
    'lulc_raster_path': 'G:\\Shared drives\\Wellcome Trust Project '
                        'Data\\1_preprocess\\UrbanCoolingModel\\OfficialWorkingInputs\\LULC\\LCM2023_London_10m_clip2aoi_tcc24_scenario4_nearest_to_edge_20prc_canopy_increase.tif',
...
if __name__ == '__main__':
    ...
    for c in climate:
        args['workspace_dir'] = f'G:\\Shared drives\\Wellcome Trust Project Data\\2_postprocess_intermediate\\UCM_official_runs\\scenario4\\{c}_climate\\tcc_20prc'
        ...
        for temp, uhi in variables:
            ...
            args['results_suffix'] = f'london_{c}_scenario4_20prc_{temp}deg_{uhi}uhi'
