...
if __name__ == '__main__':
    ...
    args['lulc_raster_path'] = os.path.join(path_prefix, '1_preprocess/UrbanCoolingModel/OfficialWorkingInputs/LULC/LCM2023_London_10m_clip2aoi_tcc24_scenario4_nearest_to_edge_20prc_canopy_increase.tif')
    ...
    for c in climate:
        ...
        for temp, uhi, hum in variables:
            ...
            if sys.argv[2] == '--eap':
                ...
                args['workspace_dir'] = os.path.join(path_prefix, '2_postprocess_intermediate/UCM_official_runs/scenario4/work_and_energy_runs/tcc_20prc')
                args['results_suffix'] = f'london_scenario4_20prc_{temp}deg_{uhi}uhi_{hum}hum_energy_productivity'
