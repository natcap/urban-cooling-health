...
# for the scenario 4 10% increase (--eap flag will run work productivity and energy)
python execute_invest_urban_cooling_model_scenario_10prc_TCC.py $path_prefix --eap
