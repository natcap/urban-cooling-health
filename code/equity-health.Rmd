...
f <- paste0('./figures/equity_map_biscale/', paste('equity_map_health', outcome_ind, sv_i, lc_snr, ymd, sep = '_'), '-test.png'); f
ggsave(plot = last_plot(), filename = f, width = 7, height = 5, units = 'in', dpi = 300)
```
...
for (var in metrics) {
  ...
  # 5. Save
  f <- paste0('./figures/equity_map_biscale/', paste('equity_map_health', outcome_ind, var, lc_snr, ymd, sep = '_'), '-neg.png'); f
