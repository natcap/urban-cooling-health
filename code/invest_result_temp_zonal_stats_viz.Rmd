...
df <- d %>%
  mutate(
    year = case_when(
      ...
      str_detect(raster, "22deg_2uhi")     ~ '2030 - 22_2',
      str_detect(raster, "25.0deg_5.0uhi") ~ '2050 - 25_5',
      str_detect(raster, "25deg_5uhi")     ~ '2050 - 25_5',
      str_detect(raster, "28deg_5uhi")     ~ '2070 - 28_5',
      TRUE ~ NA_character_
    )
  ) %>%
...
shp_all_ <- shp_all %>%
  ...
  mutate(
    ...
    year = case_when(
      str_detect(id, "_20_2")            ~ '2023-20_2',
      # str_detect(id, "_20_5") ~ '20_5',
      
      str_detect(id, "_22_2|22deg_2uhi") ~ '2030-22_2',
      str_detect(id, "_22_5|22deg_5uhi") ~ '2030-22_5',
      
      # str_detect(id, "_25_2|25deg_2uhi") ~ '25_2',
      str_detect(id, "_25_5|25deg_5uhi") ~ '2050-25_5', # 2050
      
      # str_detect(id, "_28_2|28deg_2uhi") ~ '28_2', 
      str_detect(id, "_28_5|28deg_5uhi") ~ '2070-28_5', 
      TRUE ~ NA_character_
    )
  ) %>%
...
df_summary_fromshp %>%
  ...
  facet_wrap(~ lc_scenario, scale = 'free', ncol = 4) +
  labs(
    x = "Year",
    y = "Mean ± SD",
  ) +
...
func_plot_line <- function(data, legend.position.y = 0.21){
  ...
  p <- df_stats %>%
    ...
    labs(
      title = paste0(ind_label, " difference from baseline (Scenario 0)"),
      subtitle = "Greening scenarios compared to baseline - darker green indicates more greening",
      x = "Year",
...
func_plot_line(data = df_stats, legend.position.y = 0.81)
...
func_plot_map(data = df_change_sf)
